  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-th-list"></i>Admin Table</h1>
        <p>Admin,Super,Lecturer,else..</p>
      </div>
          ...
          <div class="tile-body">
            <div  class="col-md-12 p-2 m-2 row ">
              <div class="col-md-6 justify-content-start align-items-center">
                <h5 class="h5"><i class="fa fa-table"></i><strong> Admins Table</strong></h5>
              </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <img src="{{url('images/admins/'.$admin->image)}}" style="height: 50px; width:50px">
                    </td>
                    ...
                    <td>
                      <div class="btn-group">
                        <a style="height: 30px; width:100px;" href="{{route('Admin.admins.edit',[$admin->id])}}" class="btn btn-primary d-flex justify-content-center align-items-center ml-1"><i class="fa fa-edit "></i><small>Edit</small></a>
