  ...
  <main class="app-content">
    ...
    <div class="col-md-12">
      <div class="row d-flex justify-content-between m-2">
          ...
          <div>
            <a href="{{route('Admin.courses.create')}}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>New Courses</a>
          </div>
      </div>  
            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                 ...
                 <tr>
                  <td>{{$course->name}}</td>
                  <td>{{$course->Colleges->name}}</td>
                  <td>{{$course->Sections->name}}</td>
                  <td>{{$course->hours}}</td>
                  <td>
                    <div class="btn-group">
                      <a style="height: 30px; width:100px;" href="{{route('Admin.courses.edit',$course->id)}}" class="btn btn-primary d-flex justify-content-center align-items-center ml-1"><i class="fa fa-edit "></i><small>Edit</small></a>
